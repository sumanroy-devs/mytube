---
name: unit-testing
description: Guidelines, patterns, and best practices for writing Kotlin unit tests for ViewModels, Repositories, and Utilities in the MyTube Android project.
---

# Kotlin Unit Testing Guidelines & Best Practices for MyTube

This skill outlines the standards and conventions for writing unit tests in the MyTube codebase (`io.github.aedev.flow`).
